...
import styles from "./ApplyingItem.scss";

class ApplyingItem extends React.Component{
    render(){
        ...
        let agree = () => {
            command.agree(order.orderid);
        };
        return (
            <dd className={styles.applyingItem}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.otherInfo}>
                        {command ? <p>ApplyTime: {order.applyTime}</p> : ""}
                    </div>
